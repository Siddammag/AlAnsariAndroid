...
/**
 * Created by Parveen Dala on 21 November, 2016
...
public class DeviceInfo {
    ...
    public static String getDeviceInfo(Context activity, Device device, boolean empty) {
        try {
            switch (device) {
    ...
    private static int[] getCpuUsageStatistic() {
        try {
            ...
            e.printStackTrace();
            LogUtils.e("executeTop", "e in getting cpu statics");
            return null;
        }
    }
    ...
    private static String executeTop() {
        ...
        try {
            ...
            LogUtils.e("executeTop", "e in getting first line of top");
            e.printStackTrace();
        } finally {
            try {
                in.close();
                ...
                LogUtils.e("executeTop", "e in closing and destroying top process");
                e.printStackTrace();
            }
        }
        return returnString;
    ...
    public static String getDataType(Context activity) {
        ...
        switch (tm.getNetworkType()) {
            ...
            case TelephonyManager.NETWORK_TYPE_GPRS:
                ...
                LogUtils.d("Type", "GPRS");
                break;
            case TelephonyManager.NETWORK_TYPE_EDGE:
                type = "Mobile Data EDGE 2G";
                LogUtils.d("Type", "EDGE 2g");
                break;
