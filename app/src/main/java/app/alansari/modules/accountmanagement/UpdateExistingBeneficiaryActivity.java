 ...
 * AlAnsari
 */
public class UpdateExistingBeneficiaryActivity extends AppCompatActivity implements View.OnClickListener, OnWebServiceResult, CustomClickListener, DatePickerDialog.OnDateSetListener , LogOutTimerUtil.LogOutListener  {
                ...
                if (view.getTag() != null) {
                    ...
                    if (fieldId.equalsIgnoreCase(String.valueOf(Constants.AREX_FIELD_ID_NATIONALITY))) {
                       /* intent = new Intent(context, SelectCountryFlagActivity.class);
                        ...
                        intent.putExtra(Constants.ITEM_TYPE, ((BeneficiaryDynamicFields) view.getTag()).getId());
                        intent.putExtra(Constants.TITLE, ((BeneficiaryDynamicFields) view.getTag()).getFieldName());
                        intent.putExtra("BANK_ID", ((BeneficiaryDynamicFields) view.getTag()).getBankId());
                        intent.putExtra("FIELD_ID", ((BeneficiaryDynamicFields) view.getTag()).getFieldId());
                        intent.putExtra("FIELD_KEY", ((BeneficiaryDynamicFields) view.getTag()).getField_key());
                        intent.putExtra("CURRENCY_ID", ((BeneficiaryDynamicFields) view.getTag()).getCurrencyId());
                        intent.putExtra("COUNTRY_ID", ((BeneficiaryDynamicFields) view.getTag()).getCountryId());

                      /*  Log.e("fcnajkfbcja",""+((BeneficiaryDynamicFields) view.getTag()).getFieldId());
                        Log.e("fcnajkfbcja",""+((BeneficiaryDynamicFields) view.getTag()).getField_key());
                        Log.e("fcnajkfbcja",""+((BeneficiaryDynamicFields) view.getTag()).getBankId());
                        Log.e("fcnajkfbcja",""+((BeneficiaryDynamicFields) view.getTag()).getCurrencyId());
                        Log.e("fcnajkfbcja",""+((BeneficiaryDynamicFields) view.getTag()).getCountryId());*/

                      /*  for(int i=0;i<beneficiaryDynamicFields.size();i++){
                            Log.e("fcnajkfbcja",""+(beneficiaryDynamicFields.get(i).getField_key()));
                        }*/


                        //Log.e("fhuasgcvgbf",""+selectedBank.getBankCodeCE());
                       /* Log.e("fhuasgcvgbf",""+selectedBank.getCountryData().getCountryCodeCE());
                    ...
                    /*    intent.putExtra("country_id","");
                        ...
                        /*if (fieldId.equalsIgnoreCase(String.valueOf(Constants.SELECT_ITEM_BENF_FIELD_ID_6))) {
                        ...
                        startActivityForResult(intent, Integer.valueOf(((BeneficiaryDynamicFields) view.getTag()).getId()));
                    }
                    overridePendingTransition(app.alansari.R.anim.pump_top_to_up, app.alansari.R.anim.hold);
    ...
    private void updateDynamicFields() {
        ...
        try {
            ...
            for (int i = 0; i < beneficiaryDynamicFields.size(); i++) {
               ...
               /* Log.e("sfchnsjkdbhfc",""+dynamicEditText[3].getText().toString());
                Log.e("sfchnsjkdbhfc",""+dynamicEditText[i].getText().toString());*/
                dynamicLayout.addView(childLayout);
               /* if(dynamicEditText[i].getText().toString().equalsIgnoreCase("City/Emirates Name")){
                    dynamicEditText[i].setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Toast.makeText(context, "vslkvfjsn", Toast.LENGTH_SHORT).show();
                        }
            ...
            for (int i = 0; i < beneficiaryDynamicFields.size(); i++) {
                try {
                    ...
                    if (beneficiaryDynamicFields.get(i).getFieldType().equalsIgnoreCase("DROPDOWN") && dynamicEditText[i].getTag(app.alansari.R.id.VIEW_TAG_CODE_ID) != null)
                        if (!beneficiaryDynamicFields.get(i).getFieldId().equalsIgnoreCase("6")) {
