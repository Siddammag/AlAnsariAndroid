...
public class IdProofCeData implements Parcelable {
    ...
    public IdProofCeData() {
    }

    protected IdProofCeData(Parcel in) {
    ...
    public static final Parcelable.Creator<IdProofCeData> CREATOR = new Parcelable.Creator<IdProofCeData>() {
        @Override
        public IdProofCeData createFromParcel(Parcel source) {
            return new IdProofCeData(source);
        }

        @Override
        public IdProofCeData[] newArray(int size) {
            return new IdProofCeData[size];
        }
    };
}
