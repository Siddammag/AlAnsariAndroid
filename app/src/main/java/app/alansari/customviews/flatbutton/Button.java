...
public abstract class Button extends CustomView {
    ...
    protected void setDefaultProperties() {
        // Min size
        setMinimumHeight(CommonUtils.dpToPx(minHeight, getResources()));
        setMinimumWidth(CommonUtils.dpToPx(minWidth, getResources()));
        // Background shape
    ...
    public Bitmap makeCircle() {
        Bitmap output = Bitmap.createBitmap(
                getWidth() - CommonUtils.dpToPx(6, getResources()), getHeight()
                        - CommonUtils.dpToPx(7, getResources()), Config.ARGB_8888);
