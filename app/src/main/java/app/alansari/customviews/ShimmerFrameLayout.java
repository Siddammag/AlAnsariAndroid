...
/**
 * Created by Parveen Dala on 26 December, 2016
...
public class ShimmerFrameLayout extends FrameLayout {
    ...
    public ShimmerFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, app.alansari.R.styleable.ShimmerFrameLayout, 0, 0);
            try {
                if (a.hasValue(app.alansari.R.styleable.ShimmerFrameLayout_auto_start)) {
                    setAutoStart(a.getBoolean(app.alansari.R.styleable.ShimmerFrameLayout_auto_start, false));
                }
                if (a.hasValue(app.alansari.R.styleable.ShimmerFrameLayout_base_alpha)) {
                    setBaseAlpha(a.getFloat(app.alansari.R.styleable.ShimmerFrameLayout_base_alpha, 0));
                }
                if (a.hasValue(app.alansari.R.styleable.ShimmerFrameLayout_duration)) {
                    setDuration(a.getInt(app.alansari.R.styleable.ShimmerFrameLayout_duration, 0));
                }
                if (a.hasValue(app.alansari.R.styleable.ShimmerFrameLayout_repeat_count)) {
                    setRepeatCount(a.getInt(app.alansari.R.styleable.ShimmerFrameLayout_repeat_count, 0));
                }
                if (a.hasValue(app.alansari.R.styleable.ShimmerFrameLayout_repeat_delay)) {
                    setRepeatDelay(a.getInt(app.alansari.R.styleable.ShimmerFrameLayout_repeat_delay, 0));
                }
                if (a.hasValue(app.alansari.R.styleable.ShimmerFrameLayout_repeat_mode)) {
                    setRepeatMode(a.getInt(app.alansari.R.styleable.ShimmerFrameLayout_repeat_mode, 0));
                }

                if (a.hasValue(app.alansari.R.styleable.ShimmerFrameLayout_angle)) {
                    int angle = a.getInt(app.alansari.R.styleable.ShimmerFrameLayout_angle, 0);
                    switch (angle) {
                        default:
                        case 0:
                ...
                if (a.hasValue(app.alansari.R.styleable.ShimmerFrameLayout_shape)) {
                    int shape = a.getInt(app.alansari.R.styleable.ShimmerFrameLayout_shape, 0);
                    switch (shape) {
                        default:
                        case 0:
                ...
                if (a.hasValue(app.alansari.R.styleable.ShimmerFrameLayout_dropoff)) {
                    mMask.dropoff = a.getFloat(app.alansari.R.styleable.ShimmerFrameLayout_dropoff, 0);
                }
                if (a.hasValue(app.alansari.R.styleable.ShimmerFrameLayout_fixed_width)) {
                    mMask.fixedWidth = a.getDimensionPixelSize(app.alansari.R.styleable.ShimmerFrameLayout_fixed_width, 0);
                }
                if (a.hasValue(app.alansari.R.styleable.ShimmerFrameLayout_fixed_height)) {
                    mMask.fixedHeight = a.getDimensionPixelSize(app.alansari.R.styleable.ShimmerFrameLayout_fixed_height, 0);
                }
                if (a.hasValue(app.alansari.R.styleable.ShimmerFrameLayout_intensity)) {
                    mMask.intensity = a.getFloat(app.alansari.R.styleable.ShimmerFrameLayout_intensity, 0);
                }
                if (a.hasValue(app.alansari.R.styleable.ShimmerFrameLayout_relative_width)) {
                    mMask.relativeWidth = a.getFloat(app.alansari.R.styleable.ShimmerFrameLayout_relative_width, 0);
                }
                if (a.hasValue(app.alansari.R.styleable.ShimmerFrameLayout_relative_height)) {
                    mMask.relativeHeight = a.getFloat(app.alansari.R.styleable.ShimmerFrameLayout_relative_height, 0);
                }
                if (a.hasValue(app.alansari.R.styleable.ShimmerFrameLayout_tilt)) {
                    mMask.tilt = a.getFloat(app.alansari.R.styleable.ShimmerFrameLayout_tilt, 0);
                }
            } finally {
                a.recycle();
            }
     ...
     * <p/>
     * If it fails with an OutOfMemory e, it will force a GC and then try to create the bitmap
     * one more time.
     *
