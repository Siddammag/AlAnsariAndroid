...
public class AesCbcWithIntegrity {
    ...
    public static byte[] decrypt(CipherTextIvMac civ, SecretKeys secretKeys) throws GeneralSecurityException {
        LogUtils.d("ok", "DecryptResponse:   " + civ.toString());
        ...
        if (constantTimeEq(computedMac, civ.getMac())) {
            ...
            LogUtils.d("ok", "DecryptResponse: Complete  ");
    ...
    public static final class PrngFixes {
        ...
        private static void installLinuxPRNGSecureRandom() throws SecurityException {
            ...
            synchronized (java.security.Security.class) {
                ...
                if (!rng2.getProvider().getClass().getSimpleName().equals("LinuxPRNGSecureRandomProvider")) {
                    if (ALLOW_BROKEN_PRNG) {
                        LogUtils.w(PrngFixes.class.getSimpleName(), "SecureRandom.getInstance(\"SHA1PRNG\") backed by wrong" + " Provider: " + rng2.getProvider().getClass());
                        return;
                    } else {
        ...
        private static byte[] generateSeed() {
            try {
                ...
                LogUtils.d("ok", "MyPID " + Process.myPid() + "   " + Process.myUid());
        ...
        private static byte[] getBuildFingerprintAndDeviceSerial() {
            ...
            LogUtils.d("ok", "DeviceSerialNumber " + serial);
            if (serial != null) {
