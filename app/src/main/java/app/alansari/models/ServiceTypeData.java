...
public class ServiceTypeData implements Parcelable {
    ...
    protected ServiceTypeData(Parcel in) {
        id = in.readString();
        name = in.readString();
    ...
    public static final Creator<ServiceTypeData> CREATOR = new Creator<ServiceTypeData>() {
        @Override
        public ServiceTypeData createFromParcel(Parcel in) {
            return new ServiceTypeData(in);
        }

        @Override
        public ServiceTypeData[] newArray(int size) {
            return new ServiceTypeData[size];
        }
    };
}
