package app.alansari.imageview;
...
public class RoundedImageView extends ImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, app.alansari.R.styleable.RoundedImageView, defStyle, 0);

        int index = a.getInt(app.alansari.R.styleable.RoundedImageView_android_scaleType, -1);
        if (index >= 0) {
        ...
        cornerRadius = a.getDimensionPixelSize(app.alansari.R.styleable.RoundedImageView_riv_corner_radius, -1);
        borderWidth = a.getDimensionPixelSize(app.alansari.R.styleable.RoundedImageView_riv_border_width, -1);
        ...
        borderColor = a.getColorStateList(app.alansari.R.styleable.RoundedImageView_riv_border_color);
        if (borderColor == null) {
            borderColor = ColorStateList.valueOf(RoundedDrawable.DEFAULT_BORDER_COLOR);
        }

        mutateBackground = a.getBoolean(app.alansari.R.styleable.RoundedImageView_riv_mutate_background, false);
        isOval = a.getBoolean(app.alansari.R.styleable.RoundedImageView_riv_oval, false);

        final int tileMode = a.getInt(app.alansari.R.styleable.RoundedImageView_riv_tile_mode, TILE_MODE_UNDEFINED);
        if (tileMode != TILE_MODE_UNDEFINED) {
            setTileModeX(parseTileMode(tileMode));
            setTileModeY(parseTileMode(tileMode));
        }

        final int tileModeX = a.getInt(app.alansari.R.styleable.RoundedImageView_riv_tile_mode_x, TILE_MODE_UNDEFINED);
        if (tileModeX != TILE_MODE_UNDEFINED) {
            setTileModeX(parseTileMode(tileModeX));
        }

        final int tileModeY = a.getInt(app.alansari.R.styleable.RoundedImageView_riv_tile_mode_y, TILE_MODE_UNDEFINED);
