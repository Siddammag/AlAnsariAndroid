package app.alansari.residemenu;
...
public class ResideMenu extends FrameLayout {
    ...
    private void initViews(Context context, int customLeftMenuId, int customRightMenuId) {
        ...
        inflater.inflate(app.alansari.R.layout.residemenu_custom, this);
        setFitsSystemWindows(true);
        if (customLeftMenuId >= 0) {
            scrollViewLeftMenu = inflater.inflate(customLeftMenuId, this, false);
        } else {
            scrollViewLeftMenu = inflater.inflate(app.alansari.R.layout.residemenu_custom_left_scrollview, this, false);
        ...
        if (customRightMenuId >= 0) {
            ...
            scrollViewRightMenu = inflater.inflate(app.alansari.R.layout.residemenu_custom_right_scrollview, this, false);
        ...
        RelativeLayout menuHolder = (RelativeLayout) findViewById(app.alansari.R.id.sv_menu_holder);
    ...
    protected boolean fitSystemWindows(Rect insets) {
        ...
        if (!hasBackKey || !hasHomeKey || hasNavBar(getContext())) {//there's a navigation bar
    ...
    public boolean hasNavBar(Context context) {
        ...
        ((AppCompatActivity) context).getWindowManager().getDefaultDisplay().getSize(screenSize);
    ...
    //@Override
    protected boolean fitSystemWindows1(Rect insets) {
