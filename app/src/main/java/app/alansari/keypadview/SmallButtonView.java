...
public class SmallButtonView extends FrameLayout {
    ...
    public SmallButtonView(Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(app.alansari.R.layout.small_button_view, this, true);
        ...
        text.setTextColor(ContextCompat.getColor(context, app.alansari.R.color.default_small_button_text_color));
        text.setTextSize(resources.getInteger(app.alansari.R.integer.default_small_button_text_size));

        clickEffect = findViewById(app.alansari.R.id.click_effect);
