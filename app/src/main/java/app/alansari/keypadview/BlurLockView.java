...
import app.alansari.keypadview.Directions.HideType;
import app.alansari.keypadview.Directions.ShowType;
...
public class BlurLockView extends FrameLayout implements BigButtonView.OnPressListener, SmallButtonView.OnPressListener {
    ...
    private void init() {
        // number password
        LayoutInflater.from(getContext()).inflate(app.alansari.R.layout.number_blur_lock_view, this, true);
        bigButtonViews = new BigButtonView[10];
        bigButtonViews[0] = (BigButtonView) findViewById(app.alansari.R.id.button_0);
        bigButtonViews[1] = (BigButtonView) findViewById(app.alansari.R.id.button_1);
        bigButtonViews[2] = (BigButtonView) findViewById(app.alansari.R.id.button_2);
        bigButtonViews[3] = (BigButtonView) findViewById(app.alansari.R.id.button_3);
        bigButtonViews[4] = (BigButtonView) findViewById(app.alansari.R.id.button_4);
        bigButtonViews[5] = (BigButtonView) findViewById(app.alansari.R.id.button_5);
        bigButtonViews[6] = (BigButtonView) findViewById(app.alansari.R.id.button_6);
        bigButtonViews[7] = (BigButtonView) findViewById(app.alansari.R.id.button_7);
        bigButtonViews[8] = (BigButtonView) findViewById(app.alansari.R.id.button_8);
        bigButtonViews[9] = (BigButtonView) findViewById(app.alansari.R.id.button_9);
        ...
        mBlurView = (BlurView) findViewById(app.alansari.R.id.blurview);
        ...
        indicator = (Indicator) findViewById(app.alansari.R.id.indicator);
        indicator.setPasswordLength(passwordLength);

        title = (TextView) findViewById(app.alansari.R.id.title);
        title.setTextColor(ContextCompat.getColor(getContext(), app.alansari.R.color.default_title_text_color));
        title.setTextSize(resources.getInteger(app.alansari.R.integer.default_title_text_size));

        leftButton = (TextView) findViewById(app.alansari.R.id.left_button);
        leftButton.setTextColor(ContextCompat.getColor(getContext(), app.alansari.R.color.default_left_button_text_color));
        leftButton.setTextSize(resources.getInteger(app.alansari.R.integer.default_left_button_text_size));
        ...
        rightButton = (TextView) findViewById(app.alansari.R.id.right_button);
        rightButton.setTextColor(ContextCompat.getColor(getContext(), app.alansari.R.color.default_right_button_text_color));
        rightButton.setTextSize(resources.getInteger(app.alansari.R.integer.default_right_button_text_size));
    ...
    private void showText(boolean smoothly) {
        ...
        if (smoothly) {
            ObjectAnimator.ofFloat(findViewById(app.alansari.R.id.layout_123), "alpha", 1f, 0f).setDuration(500).start();
            ObjectAnimator.ofFloat(findViewById(app.alansari.R.id.layout_456), "alpha", 1f, 0f).setDuration(500).start();
            ObjectAnimator.ofFloat(findViewById(app.alansari.R.id.layout_789), "alpha", 1f, 0f).setDuration(500).start();
            ObjectAnimator.ofFloat(findViewById(app.alansari.R.id.button_0), "alpha", 1f, 0f).setDuration(500).start();
            ObjectAnimator showAnimator = ObjectAnimator.ofFloat(findViewById(app.alansari.R.id.text_layout), "alpha", 0f, 1f);
            showAnimator.setDuration(500).addListener(new AnimatorListenerAdapter() {
                @Override
                public void onAnimationStart(Animator animation) {
                    super.onAnimationStart(animation);
                    findViewById(app.alansari.R.id.text_layout).setVisibility(VISIBLE);
                }

                @Override
                public void onAnimationEnd(Animator animation) {
                    super.onAnimationEnd(animation);
                    findViewById(app.alansari.R.id.layout_123).setVisibility(INVISIBLE);
                    findViewById(app.alansari.R.id.layout_456).setVisibility(INVISIBLE);
                    findViewById(app.alansari.R.id.layout_789).setVisibility(INVISIBLE);
                    findViewById(app.alansari.R.id.button_0).setVisibility(INVISIBLE);
    ...
    private void showNumber(boolean smoothly) {
        ...
        animationIsPlaying = true;
        if (smoothly) {
            ObjectAnimator.ofFloat(findViewById(app.alansari.R.id.layout_123), "alpha", 0f, 1f).setDuration(500).start();
            ObjectAnimator.ofFloat(findViewById(app.alansari.R.id.layout_456), "alpha", 0f, 1f).setDuration(500).start();
            ObjectAnimator.ofFloat(findViewById(app.alansari.R.id.layout_789), "alpha", 0f, 1f).setDuration(500).start();
            ObjectAnimator.ofFloat(findViewById(app.alansari.R.id.button_0), "alpha", 0f, 1f).setDuration(500).start();
            ObjectAnimator showAnimator = ObjectAnimator.ofFloat(findViewById(app.alansari.R.id.text_layout), "alpha", 1f, 0f);
            showAnimator.setDuration(500).addListener(new AnimatorListenerAdapter() {
                @Override
                public void onAnimationStart(Animator animation) {
                    super.onAnimationStart(animation);
                    findViewById(app.alansari.R.id.layout_123).setVisibility(VISIBLE);
                    findViewById(app.alansari.R.id.layout_456).setVisibility(VISIBLE);
                    findViewById(app.alansari.R.id.layout_789).setVisibility(VISIBLE);
                    findViewById(app.alansari.R.id.button_0).setVisibility(VISIBLE);
                }

                @Override
                public void onAnimationEnd(Animator animation) {
                    super.onAnimationEnd(animation);
                    findViewById(app.alansari.R.id.text_layout).setVisibility(INVISIBLE);
                    animationIsPlaying = false;
                }
            });
            showAnimator.start();
