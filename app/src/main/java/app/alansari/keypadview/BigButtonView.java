...
public class BigButtonView extends FrameLayout implements View.OnClickListener {
    ...
    //private ObjectAnimator clickEffectAnimator, clickEffectAnimator2;
    ...
    public BigButtonView(Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(app.alansari.R.layout.big_button_view, this, true);

        //Resources resources = getResources();

        frameLayout = (FrameLayout) findViewById(app.alansari.R.id.frame_layout);

        text = (TextView) findViewById(app.alansari.R.id.text);
        ...
        CommonUtils.setLayoutFont(context, "HelveticaNeue.ttf", text);

        subText = (TextView) findViewById(app.alansari.R.id.sub_text);
...
//
//        clickEffectAnimator2 = ObjectAnimator.ofInt(text, "textColor", ContextCompat.getColor(context, R.color.colorWhite), ContextCompat.getColor(context, R.color.default_big_button_text_color));
//        clickEffectAnimator2.setDuration(duration * 2);
//        clickEffectAnimator2.setEvaluator(new ArgbEvaluator());
//        clickEffectAnimator2.setInterpolator(new DecelerateInterpolator(2));
        //clickEffectAnimator2.start();
...
//            clickEffectAnimator.start();
//        }
//        if (text.getTextColors().getDefaultColor() == ContextCompat.getColor(context, R.color.colorWhite)) {
//            clickEffectAnimator2.cancel();
//            clickEffectAnimator2.start();
//        }
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case app.alansari.R.id.text:
                if (onPressListener != null) {
                    onPressListener.onPress(textString);
                }
                break;
        }
    }
